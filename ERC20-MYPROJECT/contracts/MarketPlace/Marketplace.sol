...
contract Marketplace is Ownable {
    ...
    EnumerableSet.AddressSet private _supportPaymentToken;
    ...
    function isFeeRecipient(address feeRecipient_) public view returns(bool) {
        return feeRecipient_ == feeRecipient;
    ...
    function addPaymentToken(address paymentToken_) external onlyOwner {
        ...
        require(
            _supportPaymentToken.add(paymentToken_),
    ...
    function isPaymentTokenSupported(address paymentToken_)
        ...
        returns (bool)
    {
        return _supportPaymentToken.contains(paymentToken_);
    }
    ...
    function excuteOrder(uint256 orderId_) external {
        Order storage _order = orders[orderId_];
        require(_order.price > 0, "NFTMarketplace: price must be greater than 0");
        require(
